// HM Tracker v4.2 - Sprint 1+2+3+4 (Deep Analytics)
let CUR='dash',WI=0;
const EMO=['','\uD83D\uDE2B','\uD83D\uDE23','\uD83D\uDE15','\uD83D\uDE10','\uD83D\uDE42','\uD83D\uDE0A','\uD83D\uDE04','\uD83D\uDE03','\uD83E\uDD29','\uD83D\uDD25'];
...
async function syncStr(){toast('Synchronizuje...');const n=await Strava.syncWorkouts();toast(n>0?'Zsynchronizowano '+n+' treningow!':'Brak nowych. Dane szczegolowe pobrane.');nav(CUR)}
